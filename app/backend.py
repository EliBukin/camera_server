...
class ThreadSafeCameraController:
    ...
    def set_default_values(self):
        ...
        if 'auto_exposure' in default_values:
            if not self.set_control_value('auto_exposure', default_values['auto_exposure']):
                failed_controls.append('auto_exposure')
            if 'exposure_time_absolute' in default_values:
                self.set_control_value('exposure_time_absolute', default_values['exposure_time_absolute'])
